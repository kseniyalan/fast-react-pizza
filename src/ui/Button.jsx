...
function Button({ children, disabled, to, size }) {
  ...
  const base = "bg-yellow-400 uppercase font-semibold text-stone-800 tracking-wide inline-block rounded-full hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed";
